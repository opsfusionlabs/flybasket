...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDArxAFcnCgz7xmveZFLVgWkuocoRfumfA&libraries=drawing&v=weekly"></script>
<script>
    ...
    methods: {
      ...
      const checkGoogleMaps = setInterval(() => {
        ...
        setMap() {
            ...
            let boundary_points = JSON.parse(this.boundary_points);
