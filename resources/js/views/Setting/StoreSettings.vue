    ...
    <form method="post" enctype="multipart/form-data" @submit.prevent="saveRecordLoginSetting">
        <div class="row">
            ...
            <div class="form-group col-md-4">
             ...
             <div v-if="login_settings.phone_login == '1'" class="form-group col-md-4" >
            ...
            <div class="col-md-4 form-group" v-if="login_settings.phone_login == 1">
                        ...
                        <div class="card-header">
                         ...
                         <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <!-- <div class="form-group col-md-4">
                                    <label for="low_stock_limit">{{ __('guest_cart') }} </label> <i class="fa fa-question-circle tooltip-icon"> <span class="tooltip-text">{{ __('product_will_be_add_incart_without_login') }}</span></i> 
                                    <div class="form-check form-switch">
                                    <input type="checkbox" true-value="1" false-value="0" class="form-check-input"
                                               name="guest_cart" id="guest_cart"
                                               v-model="store_settings.guest_cart">
                                               </div>
                                </div> -->
