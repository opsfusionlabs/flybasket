                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="firebase_authentication">{{ __('firebase_authentication') }}<small>[ {{ __('enable') }} / {{ __('disable') }} ] </small></label><br>
                                        <div class='form-check form-switch'>
                                            <input class='form-check-input' id="firebase_authentication" type='checkbox' true-value="1" false-value="0" v-model="firebase.firebase_authentication">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="custom_sms_gateway_otp_based">{{ __('custom_sms_gateway_otp_based') }}<small>[ {{ __('enable') }} / {{ __('disable') }} ] </small></label><br>
                                        <div class='form-check form-switch'>
                                            <input class='form-check-input' id="custom_sms_gateway_otp_based" type='checkbox' true-value="1" false-value="0" v-model="firebase.custom_sms_gateway_otp_based" >
                                        </div>
                                    </div>
                                </div>
                            </div>
